      ...
      >
        {({ isSubmitting }: any) => (
          <Form>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-custom h-screen  font-sans">
                  ...
                  <div className="mx-auto w-full max-w-[400px] space-y-6">
                    <div className="space-y-2 text-center">
                      ...
                      <Paragraph
                        ...
                        variant="secondary"
                      >
                        Nos alegra <Highlight>verte</Highlight> otra vez. Por
                        favor, <Highlight>inicia sesión</Highlight> con tu
